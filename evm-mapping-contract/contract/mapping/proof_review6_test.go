...
func TestReview6_H9_RouteDepositETHIgnoresInstructions(t *testing.T) {
	...
	t.Run("eth_path_ignores_deposit_to", func(t *testing.T) {
		...
		dest := routeDeposit(sender, []string{"deposit_to=hive:attacker"}, "eth", 100, chainId)
		if dest != expectedDID {
	...
	t.Run("eth_path_ignores_swap_to_plus_asset_out", func(t *testing.T) {
		...
		dest := routeDeposit(sender, []string{"swap_to=hive:attacker", "asset_out=hbd"}, "eth", 100, chainId)
		if dest != expectedDID {
	...
	t.Run("erc20_path_honors_deposit_to", func(t *testing.T) {
		...
		dest := routeDeposit(sender, []string{"deposit_to=hive:legitrecipient"}, "usdc", 100, chainId)
	...
	t.Run("eth_path_no_instructions_returns_did", func(t *testing.T) {
		...
		dest := routeDeposit(sender, nil, "eth", 100, chainId)
		if dest != expectedDID {
