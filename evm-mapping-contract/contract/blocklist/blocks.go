...
// review6 H2: keccak256Hex / equalHex (added by main for the oracle-path
// parent-hash chain check in HandleAddBlocks) are removed alongside that
// handler — the ZK verifier now owns header-chain validation.
